...
client = session.client('s3', endpoint_url='http://192.168.0.200:9000', aws_access_key_id='minioadmin',
...
class ImageTransformer(kserve.Model):
    def __init__(self, name: str, predictor_host: str):
        super().__init__(name)
        logging.info("ImageTransformer initialized")
        self.predictor_host = predictor_host
        self.ready = True
        self._key = None

    def preprocess(self, inputs: Union[Dict, InferRequest],   # CloudEvent
