...
class ServiceAccountTokenVolumeCredentials(TokenCredentials):
    """Audience-bound ServiceAccountToken in the local filesystem, that is
    ...
    def get_token(self):
        return read_sa_token(self._token_path)
