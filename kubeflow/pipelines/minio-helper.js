...
var fromNodeProviderChain = require('@aws-sdk/credential-providers').fromNodeProviderChain;
/**
...
function createMinioClient(config) {
    return __awaiter(this, void 0, void 0, function () {
        var credentials, aws_credentials, accessKey, secretKey, sessionToken, err_1, credentials, accessKey, secretKey, sessionToken, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!aws_helper_1.isS3Endpoint(config.endPoint)) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    aws_credentials = _a.sent();
                    if (aws_credentials) {
                        accessKey = aws_credentials.accessKeyId, secretKey = aws_credentials.secretAccessKey, sessionToken = aws_credentials.sessionToken;
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Unable to get credentials from AWS credential provider chain: ', err_1);
                    return [3 /*break*/, 4];
                case 4:
                    if (!(!config.accessKey || !config.secretKey)) return [3 /*break*/, 10];
                    _a.label = 5;
                case 5:
                    _a.trys.push([5, 9, , 10]);
                ...
                case 9:
                    err_2 = _a.sent();
                    console.error('Unable to get aws instance profile credentials: ', err_2);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/, new minio_1.Client(config)];
            }
        });
    });
}
...
function getObjectStream(_a) {
    var bucket = _a.bucket, key = _a.key, client = _a.client, _b = _a.tryExtract, tryExtract = _b === void 0 ? true : _b;
    return __awaiter(this, void 0, void 0, function () {
        var stream;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    stream = _c.sent();
                    return [2 /*return*/, tryExtract ? stream.pipe(gunzip_maybe_1.default()).pipe(maybeTarball()) : stream.pipe(new stream_1.PassThrough())];
            }
        });
    });
}
