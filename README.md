...
### Important ROOK-CEPH STORAGE
If you reinstall the kubeflow application including the rook-ceph storage please
follow instruction provided at https://rook.io/docs/rook/v1.6/ceph-teardown.html#zapping-devices .
## Folder setup
